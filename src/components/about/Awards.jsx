    ...
    <PageLayout>
      <div className=" grid grid-cols-1 md:grid-cols-2 mb-5 gap-5">
        <div className=" relative  px-2 md:px-0   md:pr-10">
          <Image
            className=" absolute bottom-5 h-[200px] md:h-auto max-h-[400px]  md:block  object-contain  opacity-25 "
            src={Ass}
            alt="achevement"
          />

          <div className=" space-y-4">
            <h1 className=" text-[20px] md:text-[30px] text-gradient font-label ">
              Commercial success
            </h1>

            <div className=" space-y-2">
              <h3 className=" md:text-[20px] font-semibold text-[#171717]">
                Worldwide box office
              </h3>
              <p className="text-[#404040] text-[13px] md:text-[15px] md:leading-[24px] text-justify">
            ...
            <div className=" space-y-2">
              ...
              <p className="text-[#404040] text-[13px] md:text-[15px] md:leading-[24px] text-justify">
                ...
                hours of viewership from 2020 to 2023.Upon its release on
                Disney+, Moana quickly became one of the platform’s most-watched
                titles, attracting new audiences.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className=" md:order-2 px-2 md:px-0   md:pr-10">
          <h1 className=" text-[20px] md:text-[30px] text-gradient font-label mb-2 ">
